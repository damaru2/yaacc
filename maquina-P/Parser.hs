...
action_0,
 ...
 action_72,
 action_73,
 action_74 :: () => Int -> ({-HappyReduction (HappyIdentity) = -}
	   Int 
	-> (Token)
...
happyReduce_1,
 ...
 happyReduce_44,
 happyReduce_45,
 happyReduce_46 :: () => ({-HappyReduction (HappyIdentity) = -}
	   Int 
	-> (Token)
	-> HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (HappyIdentity) HappyAbsSyn)
	-> [HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (HappyIdentity) HappyAbsSyn)] 
...
action_4 (49) = happyShift action_69
action_4 _ = happyFail

action_5 (48) = happyShift action_68
action_5 _ = happyFail

action_6 (48) = happyShift action_65
action_6 (50) = happyShift action_66
action_6 (51) = happyShift action_67
action_6 _ = happyFail

action_7 _ = happyReduce_7

action_8 (48) = happyShift action_64
action_8 _ = happyFail

action_9 _ = happyReduce_9

action_10 (48) = happyShift action_63
action_10 _ = happyFail

action_11 (48) = happyShift action_62
action_11 _ = happyFail

action_12 (48) = happyShift action_61
...
action_27 (48) = happyShift action_60
action_27 _ = happyFail

action_28 (48) = happyShift action_59
...
action_32 (48) = happyShift action_55
action_32 _ = happyFail

action_33 (48) = happyShift action_54
...
action_61 (48) = happyShift action_72
action_61 _ = happyFail

action_62 (48) = happyShift action_71
action_62 _ = happyFail

action_63 (48) = happyShift action_70
...
happyReduction_27 (HappyTerminal (Num happy_var_2))
	_
	 =  HappyAbsSyn5
		 (UJP (fst happy_var_2)
	)
...
happyReduction_28 (HappyTerminal (Num happy_var_2))
	_
	 =  HappyAbsSyn5
		 (FJP (fst happy_var_2)
	)
...
happyReduction_34 (HappyTerminal (Num happy_var_2))
	_
	 =  HappyAbsSyn5
		 (DEC (fst happy_var_2)
	)
...
happyReduction_39 (HappyTerminal (Num happy_var_2))
	_
	 =  HappyAbsSyn5
...
happyReduction_40 (HappyTerminal (Num happy_var_2))
	_
	 =  HappyAbsSyn5
...
happyNewToken action sts stk (tk:tks) =
	...
	Retp _ -> cont 46;
	Stp  _ -> cont 47;
	Num happy_dollar_dollar -> cont 48;
	SemiColon _ -> cont 49;
	TRUE _ -> cont 50;
	FALSE _ -> cont 51;
	_ -> happyError' (tk:tks)
